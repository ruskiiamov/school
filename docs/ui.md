...
`#password-status`, сами поля остаются — D-054); успех — редирект на
`?done=1` с зелёным сообщением.

Дашборд админа: приветствие и дата, при отсутствии классов — жёлтый баннер
«В 2026/2027 ещё нет классов» с кнопкой «Создать класс», ниже четыре
карточки-ссылки «Классы · Ученики · Учителя · Предметы» с числами текущего
года. Остальным ролям — приветствие и карточка-ссылка на «Журнал» или
«Дневник» с подписью «Раздел в разработке».
